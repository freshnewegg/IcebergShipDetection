...
X_full = np.concatenate([nl1[:, :, :, np.newaxis], nl2[:, :, :, np.newaxis], ratio[:,:,:,np.newaxis]], axis = -1)
...
def get_model():
    bn_model = 0
    p_activation = "elu"
    input_1 = Input(shape=(75, 75, 3), name="X_1_lee")
    ...
    #first image
    img_1 = Conv2D(24, kernel_size = (3,3), activation=p_activation) ((BatchNormalization(momentum=bn_model))(input_1))
    img_1 = MaxPooling2D((2,2)) (img_1)
    img_1 = Dense(128, activation = 'relu') (img_1)
    ...
    img_1 = Conv2D(64, kernel_size = (3,3), activation=p_activation) (img_1)
    img_1 = MaxPooling2D((2,2)) (img_1)
    img_1 = Dense(512, activation = 'relu') (img_1)
    img_1 = GlobalMaxPooling2D() (img_1)
